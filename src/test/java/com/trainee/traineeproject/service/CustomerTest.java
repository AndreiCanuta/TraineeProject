...
import com.trainee.traineeproject.controller.CustomerController;
import com.trainee.traineeproject.csvThreads.ThreadHandler;
import com.trainee.traineeproject.entity.Customer;
import com.trainee.traineeproject.entity.CustomerId;
import org.junit.jupiter.api.BeforeAll;
import org.junit.jupiter.api.Test;
import com.trainee.traineeproject.utils.PropertyReaderUtil;
...
//        System.out.println("KB: " + (double) (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024);
        threadHandler.run();
//        System.out.println("KB: " + (double) (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024);
        assertEquals(1000000, customerServiceImpl.getAllCustomers().size());
    }
